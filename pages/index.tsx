    ...
    />*/}
        ...
        <div className="infoGrid">
          ...
          <div className="infoGrid--text">
            ...
            <h4>
              MMOGadget will guide you to choose your next game, you do not need
              another platform. <br />
        ...
        <div className="gamesGrid">
          <div className="gamesGrid--text">
            <h2>Games</h2>
            <HoverLink text="Click for more" href="/games" color="primary" />
          </div>
          <div className="gamesGrid--games">
            {selector?.slice(0, 6).map((el: IGames) => (
              <Gamecard
                title={el.title}
        ...
        <div className="secondColor">
          <div className="newsGrid">
            <div className="newsGrid--text">
              <h2>News</h2>
              <HoverLink text="Click for more" href="/news" color="secondary" />
            </div>
              ...
              {newsSelector?.slice(0, 5).map((el: INews) => (
                <div className="giveawayItem" key={el.id}>
                  ...
                  <span style={{ margin: "auto 0 .25rem 0" }}>
                    <Button href={`news/${el.id}`} text="Read More" />
                  </span>
                </div>
              ))}
            </div>
            <div className="gamesGrid--subtext">
              <Button href="/news" text="Browse more news" wider />
            </div>
          </div>
        </div>
            ...
            {giveawaySelector?.slice(0, 5).map((el: IGiveaway) => (
              <div className="giveawayItem" key={el.id}>
                ...
                <div style={{ margin: "auto 0 .25rem 0" }}>
                  <Button href={el.giveaway_url || ""} text="Obtain Gift" />
                </div>
              </div>
            ))}
          </div>
          <div className="gamesGrid--subtext">
            <Button href="/giveaways" text="Browse more giveaways" wider />
          </div>
        </div>
      </main>
    </Layout>
